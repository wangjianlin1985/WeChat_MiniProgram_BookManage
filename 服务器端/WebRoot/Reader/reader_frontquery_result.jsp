...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<a class="pull-right" href="<%=basePath %>Reader/reader_frontAdd.jsp" style="display:none;">添加读者</a>
		</ul>
		<div class="row">
			<%
				/*计算起始序号*/
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>Reader/<%=reader.getReaderNo() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=reader.getPhoto()%>" /></a>
			     <div class="showFields">
			        ...
			        <a class="btn btn-primary top5" onclick="readerEdit('<%=reader.getReaderNo() %>');" style="display:none;">修改</a>
			        <a class="btn btn-primary top5" onclick="readerDelete('<%=reader.getReaderNo() %>');" style="display:none;">删除</a>
			     </div>
			</div>
			<%  } %>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="readerQueryForm" id="readerQueryForm" action="<%=basePath %>Reader/frontlist" class="mar_t15" method="post">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="reader_password_edit" class="col-md-3 text-right">登录密码:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="reader_password_edit" name="reader.password" class="form-control" placeholder="请输入登录密码">
			 </div>
		  </div>
		  <div class="form-group">
