...
public class ReaderService {
    ...
    /*根据微信openid获取读者记录*/
    public Reader getReaderByOpenid(String openid) throws Exception {
        Reader reader = readerMapper.getReaderByOpenid(openid);
        return reader;
    }
    ...
    /*关联读者微信openid记录*/
    public void updateReaderOpenid(String readerNo,String openId) throws Exception {
        readerMapper.updateReaderOpenid(readerNo, openId);
    }
